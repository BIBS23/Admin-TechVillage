...
class AddCoconutClimbers extends StatefulWidget {
  const AddCoconutClimbers({
    super.key,
  });

  @override
  State<AddCoconutClimbers> createState() => _AddCoconutClimbersState();
}

class _AddCoconutClimbersState extends State<AddCoconutClimbers> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Coconut Climbers'),
          centerTitle: true,
