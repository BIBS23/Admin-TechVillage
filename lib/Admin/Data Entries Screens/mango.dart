...
class AddMangoPickle extends StatefulWidget {
  const AddMangoPickle({
    super.key,
  });

  @override
  State<AddMangoPickle> createState() => _AddMangoPickleState();
}

class _AddMangoPickleState extends State<AddMangoPickle> {
